#############################################################################
# Makefile for building: RadarVisualizer
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  RadarVisualizer.pro
# Template: app
# Command: C:\Qt\6.4.2\mingw_64\bin\qmake.exe -o Makefile RadarVisualizer.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: RadarVisualizer.pro C:/Qt/6.4.2/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.4.2/mingw_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile RadarVisualizer.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
